...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_c_ares_c_ares = dict(
        ...
        project_desc = "C library for asynchronous DNS requests",
        project_url = "https://c-ares.haxx.se/",
        version = "1.17.1-pr393",
        sha256 = "78e55748826df6a0d9387af365cdb95349bddb7f02e473490dffb603e85d2555",
        strip_prefix = "c-ares-{version}",
        urls = ["https://github.com/c-ares/c-ares/archive/08de712a6a68bd8d2f92b2336c995c39366265a8.tar.gz"],
        use_category = ["dataplane_core", "controlplane"],
